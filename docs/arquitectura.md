...
El seeder provisional histórico requiere sus 10 padres originales y conserva sus reglas transaccionales. Desde Fase 2A no se expone como carga normal: se retiró el botón y POST LoadInitialCatalog, conservando autorización y antiforgery, informa que está deshabilitado sin invocar el seeder. No se ejecuta en Program.
